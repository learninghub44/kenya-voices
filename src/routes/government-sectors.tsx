...
import { ExternalLink, ArrowRight, Shield, DollarSign, Users, Zap, Briefcase, Globe, Map, Leaf, Home, Plane, TrendingUp, Droplet, AlertCircle, Code, Music, Handshake, Waves, BookOpen, Combine } from "lucide-react";
              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                    <div className="inline-grid h-14 w-14 place-items-center rounded-lg bg-[#C8102E]/10">
